...
i [1] [0] [1]
f 0 [ 1024 * $measure ]
i [2.1] [0] [-1] "drone" "drone" [1/2] [1] [14/16] [1] [1/2^3] [1/2^2] [2^-2] [2^-1] [10] [0] [12]
i [2.2] [0] [-1] "melody" "melody" [.9] [.9] [2^16] [2^16] [2^-1] [2^-1] [2^-2] [2^-2] [2^-8] [2^3] [2^-4]
i [3] [0] [-1]
#define drone #1/8#
i [4.1] [0] [$drone] [6] [0] [2] [0] [16] [6] [0] "drone" [2] [2] [3] [0] [0] [$drone] [3] [0]
i [4.1] [0] [$drone] [6] [0] [2] [0] [16] [6] [0 + 16] "drone" [2] [2] [3] [0] [0] [$drone] [3] [0]
i [4.1] [0] [$drone] [6] [0] [2] [0] [16] [6] [0 + 16 + 16] "drone" [2] [2] [3] [0] [0] [$drone] [3] [0]
#define measure #4#
v $measure
a 0 0 [ $measure * 0 ]
i [4.2] 0 [0] [6] [0] [2] [0] [16] [8] [0] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [0] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [3] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/2] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [3] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [0] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [3] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [13] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [12] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [4] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
...
i [4.2] + [1/8] [6] [0] [2] [0] [16] [8] [8] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [1/4] [6] [0] [2] [0] [16] [8] [9] "melody" [1] [2] [3] [0] [0] [0] [3] [0]
i [4.2] + [-1] [6] [0] [2] [0] [16] [8] [0] "melody" [1] [2] [3] [0] [1] [0] [3] [0]
