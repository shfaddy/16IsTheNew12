...
t 0 $tempo
{ 2 octave
i [4] [0] [-1] [$channel] [3] [4.75] [$octave*-16]
}
v $measure
{ 1024 beat
b [ $beat * $measure ]
{ 1 channel
i [5 + .$channel] [0] [1/2] [$channel] [0]
{ 3 finger
i [7 + .$channel + .0$finger] [1/4 + $finger/2^11] [(1/2)] [0 + ( $finger * 4 ) + ( ~ * 2 )] [$channel] [3]
i [6 + .$channel + .0$finger] [2/4 + $finger/2^9] [(1/2)] [0 + ( $finger * 4 ) + ( ~ * 2 )] [$channel] [2]
i [7 + .$channel + .0$finger] [3/4 + $finger/2^11] [(1/2)] [0 + ( $finger * 4 ) + ( ~ * 2 )] [$channel] [3]
}
}
}
s
